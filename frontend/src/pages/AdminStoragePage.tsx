  ...
  return (
    <div className="max-w-4xl mx-auto p-4">
      ...
      <div className="space-y-6">
        <div className="rounded-lg border-none bg-card p-5 space-y-4">
        ...
        <div className="rounded-lg border-none bg-card p-5 space-y-4">
          <div className="flex items-center justify-between">
            ...
            <Button type="button" size="sm" variant="outline" onClick={addRule} className="gap-1">
              <Plus weight="fill" className="h-3 w-3" /> Add Rule
            </Button>
          </div>
              ...
              <div key={i} className="grid grid-cols-12 gap-2 items-end p-3 rounded-lg bg-muted/40">
                <div className="col-span-3 space-y-1">
                  ...
                  <input
                    ...
                    className="w-full rounded-md border-none bg-card px-2 py-1.5 text-xs"
                  />
                </div>
                <div className="col-span-2 space-y-1">
                  ...
                  <input
                    ...
                    placeholder="image/*"
                    className="w-full rounded-md border-none bg-card px-2 py-1.5 text-xs font-mono"
                  />
                </div>
                <div className="col-span-3 space-y-1">
        ...
        <div className="rounded-lg border-none bg-card p-5 space-y-3">
          <h2 className="text-sm font-bold text-foreground">Available Disks</h2>
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
            {disks.map((d) => (
              <div key={d.name} className="rounded-lg border-none bg-muted/30 p-3">
