  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center h-64 text-muted-foreground">
        <RefreshCw weight="fill" className="h-6 w-6 animate-spin mr-2" /> Loading Creator Wallet...
      </div>
    );
  }
    ...
    <div className="p-4 lg:p-5 space-y-6 max-w-7xl mx-auto w-full">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <button
          ...
          className="inline-flex items-center gap-1.5 px-4 py-2.5 rounded-lg bg-purple-600 hover:bg-purple-700 text-white font-bold text-sm shadow transition"
        >
      ...
      <div className="p-4 rounded-lg border-none bg-card space-y-4 ">
        <h2 className="text-base font-bold text-foreground flex items-center gap-2">
          <Clock weight="fill" className="h-5 w-5 text-purple-500" /> Creator Earnings Rule
        </h2>
