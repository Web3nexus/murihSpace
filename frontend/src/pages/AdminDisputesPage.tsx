...
export default function AdminDisputesPage() {
  ...
  return (
    <div className="w-full mx-auto max-w-[1400px] space-y-6 p-6 lg:p-10">
      <div><h1 className="text-2xl font-black tracking-tight flex items-center gap-2.5"><ShieldAlert className="h-6 w-6 text-[#2164b6] dark:text-[#7ab0ff]" /> Disputes Management</h1><p className="text-xs text-muted-foreground mt-1">Manage refund requests and disputes.</p></div>
