    ...
    items: [
      {
        ...
        children: [
          { title: "Store Posts", url: "/app/store/posts", featureFlag: "storefront" },
          { title: "Digital Downloads", url: "/app/store/digital", featureFlag: "digital_products" },
          { title: "Online Courses", url: "/app/store/courses", featureFlag: "online_courses" },
          { title: "1:1 Coaching & Bookings", url: "/app/store/coaching", featureFlag: "coaching" },
          { title: "Physical Products & Merch", url: "/app/store/physical", featureFlag: "physical_products" },
        ],
      },
      {
        title: "Orders",
