...
export function StatCard({ 
  ...
  return (
    <div className={`relative overflow-hidden rounded-lg border-none/50 bg-card/50 backdrop-blur-xl p-5 transition-all duration-300 hover:-translate-y-1 group`}>
      ...
      <div className="relative z-10 flex flex-col gap-3">
        <div className={`w-10 h-10 rounded-lg flex items-center justify-center ${color} bg-opacity-10 text-opacity-100`}>
