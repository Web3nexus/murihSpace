...
export function OpenInAppBanner({
  ...
  return (
    <div className="relative z-50 bg-gradient-to-r from-[#102840] via-[#173852] to-[#2164b6] text-white px-4 py-2.5 shadow-md flex items-center justify-between gap-3 border-b border-white/10">
      <div className="flex items-center gap-3 min-w-0">
        <div className="h-9 w-9 rounded-xl bg-white/10 border border-white/20 flex items-center justify-center shrink-0 shadow-inner">
      ...
      <div className="flex items-center gap-2 shrink-0">
        <Button
          ...
          className="h-7 px-3 text-xs font-bold bg-white text-[#102840] hover:bg-white/90 shadow-sm rounded-lg"
        >
          Open App
        </Button>
        <button
