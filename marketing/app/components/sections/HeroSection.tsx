      ...
      <div className="mx-auto max-w-7xl px-6 relative z-10">
        ...
        >
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight leading-[1.1]">
            <span className="text-foreground">Your audience deserves </span>
          ...
          <p className="mt-6 text-lg text-muted-foreground max-w-xl leading-relaxed">
            MurihSpace gives creators everything they need to build, grow, and
            monetise — communities, storefronts, messaging, and payments, all in
            one place.
          </p>
          ...
          <div className="mt-10 flex items-center gap-6 text-sm text-muted-foreground">
            ...
            <span>
              <strong className="text-foreground">2,400+</strong> creators joined
              this month
            </span>
          </div>
        </motion.div>
